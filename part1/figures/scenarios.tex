\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    ;
  \end{tikzpicture}
  \caption{The four different types of scenarios in relation to the Y-model. Note, that the \emph{evaluation} phase is not shown to make the figure more readable. \cite[p. 67]{benyon_14}}
  \label{fig:scenarios}
\end{figure}
