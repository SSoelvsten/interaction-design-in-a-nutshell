...
\begin{longtable}{rc>{\raggedright\arraybackslash}p{.66\textwidth}}
  ...
  \\
  Social Differences & : &
  The difference within the group of users or potential users, such as the amount of experience they have with the system and if it is necessary or not of them to use the system. Looking at this should be determined if the group is homogenous or heterogenous. \cite[p. 27-30]{benyon14}
\end{longtable}
