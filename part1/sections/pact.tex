...
\begin{longtable}{rc>{\raggedright\arraybackslash}p{.66\textwidth}}
  ...
  \\
  Ergonomics & : &
  The \emph{ambient} and \emph{working} environment of section \ref{sec:ergonomics} together with the physiology of people, differentiating between physically usable and unusable
  \\
