\section{\todo : Understanding} \label{sec:understanding}
...
\input{part1/definitions/questionnaire.tex}
...
\input{part1/definitions/card_sorting.tex}
...
Together with analysing artefacts (model \ref{mod:artefact}) the following four models below are part of \emph{Work modelling}, where the different aspects of the users environment are captured \cite[p. 277]{benyon10} \index{Work modelling}
